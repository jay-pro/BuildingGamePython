...
background = pygame.image.load(os.path.join('D:/18110168_GITHUBS/BuildingGamePython/Section9-Project5/FlappyBird/assets','background-day.png')).convert()

base = pygame.image.load(os.path.join('D:/18110168_GITHUBS/BuildingGamePython/Section9-Project5/FlappyBird/assets','base.png')).convert()
base_x_pos = 0

bird_sur = pygame.image.load(os.path.join('D:/18110168_GITHUBS/BuildingGamePython/Section9-Project5/FlappyBird/assets','yellowbird.png')).convert_alpha()
